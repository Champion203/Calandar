...
<body>
  ...
  <script type="text/javascript"
    src="https://cdn-apac.onetrust.com/consent/7dbccbf7-21b3-4ce1-93a9-9c2783ada201/OtAutoBlock.js"></script>
  <script src="https://cdn-apac.onetrust.com/scripttemplates/otSDKStub.js" data-document-language="true"
    type="text/javascript" charset="UTF-8" data-domain-script="7dbccbf7-21b3-4ce1-93a9-9c2783ada201"></script>
  <script type="text/javascript">
                      ...
                      <form action="checkQ.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <div class="col-12 col-sm-4 mb-2">
                            ...
                            <input type='text' name='Name' id='Name' value='<?php echo $_SESSION['displayname_th']; ?>'
                              class='form-control' disabled>
                            <input type='text' name='department' id='department'
                              value='<?php echo $_SESSION['department']; ?>' class='form-control' hidden>
                            <label for='end'>หน่วยงาน</label>
                            <input type='text' name='organization' id='organization'
                              value='<?php echo $_SESSION['organization']; ?>' class='form-control' disabled>
                            <label for='end'>อีเมล์</label>
                            <input type='text' name='email' id='email' value='<?php echo $_SESSION['email']; ?>'
                              class='form-control' disabled>
                            <input type='text' name='Ref_Agenda_id' id='Agenda'
                              value='<?php echo $_POST['Ref_Agenda_id']; ?>' class='form-control' hidden>
                            <input type='text' name='Ref_Building_id' id='Building'
                              value='<?php echo $_POST['Ref_Building_id']; ?>' class='form-control' hidden>
                            <label for='end'>ห้อง</label>
                            <input type='text' name='Ref_Room_id' id='Room' value='<?php echo $_POST['Ref_Room_id']; ?>'
                            ...
                            <input type='date' name='booking_date' id='date'
                              min='<?php echo date('Y-m-d', $timestamp); ?>'
                              max='<?php echo date("Y-m-d", $timestampmax); ?>' class='form-control' required>
