              ...
              <div style="overflow-x:auto;">
                <div class="row">
                  <div align="right" class="col-12 col-sm-12 mb-2">
                    ...
                    <a href="DashboardAdmin.php?disapproval" class="btn btn-danger" role="button"> ไม่อนุมัติ</a>
                  </div>
                </div>
                    ...
                    <tbody>
                      <?php while ($result = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC)) {
                        ...
                        <tr>
                          ...
                          <td align="center">
                            <?php echo $result["ID_Reserve"]; ?>
                          </td>
                          <td align="center">
                            <?php echo $result["Name_Building"]; ?>
                          </td>
                          <td align="center">
                            <?php echo $result["Name_Room"]; ?>
                          </td>
                          <td align="center">
                            <?php echo $result["FullName"]; ?>
                          </td>
                          <td align="center">
                            <?php echo date_format($datestart, "วันที่ d/m/Y เวลา H:i:s น."); ?>
                          </td>
                          <td align="center">
                            <?php echo date_format($dateend, "วันที่ d/m/Y เวลา H:i:s น."); ?>
                          </td>
                          <td align="center">
                            <?php if ($result['Status_Reserve'] == 'approve') { ?>
                          ...
                          <td align="center"><a href="approve.php?ID_Reserve=<?php echo $result["ID_Reserve"]; ?>"
                              title="จัดการ"><i style='font-size:24px' class='material-icons'>&#xe065;</i></a>
                            <a href="PDF.php?id=<?php echo $result["ID"]; ?>" title="exportPDF"><i class="material-icons"
                                style="font-size:24px">&#xe555;</i></a>
                            <a href="DashboardAdmin.php?del=<?php echo $result["ID_Reserve"]; ?>" title="ลบการจอง"><i
                                class="material-icons" style="font-size:24px">&#xe92b;</i></a>
                          </td>
